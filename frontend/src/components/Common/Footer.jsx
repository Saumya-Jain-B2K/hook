...
//         <div className='container mx-auto mt-9 px-4 lg:px-0 border-t border-gray-200 pt-6'>
      ...
      <div className='container mx-auto grid 
        ...
        <div>
          ...
          <form className='flex flex-col sm:flex-row'>
            ...
            <button
              type='submit'
              className='bg-black text-white px-6 py-3 text-sm rounded-md sm:rounded-l-none sm:rounded-r-md 
              hover:bg-gray-800 transition-all mt-3 sm:mt-0'
            >
              Subscribe
            </button>
          </form>
